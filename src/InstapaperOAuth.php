<?php
namespace InstapaperAPI;
/* InstapaperOAuth
 * ------------------------------------------------------
 * A PHP Composer library for working with Instapaper's OAuth API
 * Shashank Gaurav (shashank19gaurav@gmail.com) http://shashankgaurav.com
 * 
 * This library has been extended upon the repository forked from 
 * Randy Hoyt (randy@randyhoyt.com) http://randyhoyt.com
 * to be used as composer package
 * 
 */
